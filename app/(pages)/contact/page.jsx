...
const CONTACT_ITEMS = [
  { title: "Email", value: "info@example.com", icon: Mail },
  { title: "Address", value: "Coding Str., Canggu, Bali", icon: MapPin },
  { title: "Hours", value: "Mon-Fri: 9am-5pm", icon: Clock },
